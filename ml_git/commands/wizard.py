...
def request_user_confirmation(confimation_message, default=False):
    should_continue = click.confirm(confimation_message, default=default, abort=False, prompt_suffix='?')
